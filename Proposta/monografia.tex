...
\label{sec:fem2d}
Neste tópico serão desenvolvidos os passos do FEM relacionados no tópico anterior. O exemplo apresentado foi adaptado do exemplo $6.1$ de \citeonline{sadiku}. Deseja-se saber o valor do potencial elétrico nos pontos $a$ e $b$ da placa submetida a uma diferença de potencial de $10V$, como mostra a figura \ref{fig:exemplo}[a].
